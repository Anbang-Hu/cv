function [locs,desc] = computeBriefRotationInvariant(im, GaussianPyramid, locsDoG, k, levels, compareX, compareY)
%% [locs,desc] = computeBriefRotationInvariant(im, GaussianPyramid, locsDoG, k, levels, compareX, compareY)
% Produces locs,desc
% inputs
