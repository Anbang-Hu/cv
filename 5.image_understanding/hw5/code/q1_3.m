...
%% Script for generating visualization of 1.3
%% Load images
Itrain = im2double(rgb2gray(imread('../data/test2.jpg')));
Itest = cell(6,1);
Itest{1} = im2double(rgb2gray(imread('../data/test0.jpg')));
Itest{2} = im2double(rgb2gray(imread('../data/test1.jpg')));
Itest{3} = im2double(rgb2gray(imread('../data/test3.jpg')));
Itest{4} = im2double(rgb2gray(imread('../data/test4.jpg')));
Itest{5} = im2double(rgb2gray(imread('../data/test5.jpg')));
Itest{6} = im2double(rgb2gray(imread('../data/test6.jpg')));
